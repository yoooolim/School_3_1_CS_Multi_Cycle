...
#endif
static const char *ng0 = "C:/Xilinx/Project2/ALU.v";
...
LAB88:    xsi_set_current_line(38, ng0);
    t2 = (t0 + 1528U);
    t3 = *((char **)t2);
    t2 = ((char*)((ng13)));
    memset(t6, 0, 8);
...
LAB51:    if (*((unsigned int *)t22) < *((unsigned int *)t28))
        goto LAB49;

LAB50:    t35 = (t0 + 2408);
    xsi_vlogvar_wait_assign_value(t35, t31, 0, 0, 32, 0LL);
    goto LAB46;
...
LAB56:    xsi_set_current_line(29, ng0);
    ...
    t21 = ((char*)((ng4)));
    memset(t31, 0, 8);
    xsi_vlog_unsigned_lshift(t31, 32, t22, 32, t21, 32);
    t28 = (t0 + 2408);
...
LAB63:    xsi_set_current_line(31, ng0);
    ...
    t21 = ((char*)((ng4)));
    memset(t31, 0, 8);
    xsi_vlog_unsigned_rshift(t31, 32, t22, 32, t21, 32);
    t28 = (t0 + 2408);
    xsi_vlogvar_wait_assign_value(t28, t31, 0, 0, 32, 0LL);
    goto LAB65;
...
extern void work_m_00000000000663718602_0886308060_init()
{
	static char *pe[] = {(void *)Cont_12_0,(void *)Cont_13_1,(void *)Cont_15_2,(void *)Always_17_3};
	xsi_register_didat("work_m_00000000000663718602_0886308060", "isim/tb_top_isim_beh.exe.sim/work/m_00000000000663718602_0886308060.didat");
